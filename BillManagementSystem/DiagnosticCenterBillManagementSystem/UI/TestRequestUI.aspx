...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <fieldset>
        ...
        <asp:GridView ID="showTestGridView" HorizontalAlign="Center" runat="server" AutoGenerateColumns="False" Width="479px" DataKeyNames="TestName" ShowFooter="True" OnRowDataBound="showTestGridView_RowDataBound" CellPadding="4" ForeColor="#333333" GridLines="None">
            ...
            <Columns>
                ...
                <asp:BoundField DataField="TestName" HeaderText="Test Name"
                    ReadOnly="True" SortExpression="TestName" HeaderStyle-CssClass="header-center">
